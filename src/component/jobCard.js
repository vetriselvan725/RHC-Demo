...
<>
<div className="flex flex-col sm:flex-row justify-between items-center gap-4 border rounded-xl shadow-xl bg-white p-10 mt-10" data-aos="zoom-in" data-aos-duration="2000">
      <ul className="w-full flex flex-col sm:flex-row gap-6 list-none mx-auto">
        ...
        <li className="flex flex-col w-full items-center sm:items-start">
          <label className="font-bold text-gray-700 text-2xl text-center sm:text-left">JobType</label>
          <p className="font-medium text-xl text-gray-600 text-center sm:text-left mt-10">{job.JobType}</p>
        </li>
        <li className="flex flex-col w-full items-center sm:items-start">
