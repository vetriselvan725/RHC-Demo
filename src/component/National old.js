                ...
                <div className="md:mx-[10px] mx-auto py-14 px-4 sm:px-6 lg:px-12">
                    <div className="text-center sm:text-start">
                        ...
                        <div className="bg-white rounded-xl shadow-lg flex flex-col sm:flex-row items-center p-2 space-y-2 sm:space-y-0 sm:space-x-2">
                            <select className="text-2xl bg-transparent border-none outline-none text-gray-500 p-2 rounded-full w-full sm:w-1/4">
                                <option value="">Select sector</option>
                                <option value="Clinical">Clinical</option>
                                <option value="NON Clinical">NON Clinical</option>
                            </select>
                            <input type="text" placeholder="Job title or Keyword" className="text-2xl  bg-transparent border-none outline-none flex-grow p-4 text-gray-700 w-full sm:w-auto" value="" />
                            <input type="text" placeholder="Set your location" className="text-2xl  bg-transparent border-none outline-none flex-grow p-4 text-gray-700 w-full sm:w-auto" value="" />
                            <button className="bg-blue-600 text-2xl text-white px-8 py-3 rounded-xl hover:bg-blue-700 w-full sm:w-auto">Search</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="mb-4 mt-6">
                        ...
                        <div className="space-y-2 text-sm sm:text-2xl">
                            <label className="flex items-center">
                                <input type="checkbox" name="Permanent" className="mr-2 w-5 h-5" />Permanent</label>
                            <label className="flex items-center pt-3">
                                <input type="checkbox" name="PartTime" className="mr-2 w-5 h-5" />PartTime</label>
                            <label className="flex items-center pt-3">
                                <input type="checkbox" name="Contract" className="mr-2 w-5 h-5" />Contract</label>
                            <label className="flex items-center pt-3">
                                <input type="checkbox" name="Internship" className="mr-2 w-5 h-5" />Internship</label>
                        </div>
                    </div>
                    <div className="mb-4 mt-6">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-sm sm:text-3xl font-bold">Employment Type</h2>
                            <button className="focus:outline-none">▲</button></div>
                            <div className="space-y-2 text-sm sm:text-2xl">
                            <label className="flex items-center pt-3">
                                <input type="checkbox" name="Full_time" className="mr-2 w-5 h-5" />Full_time</label>
                            <label className="flex items-center pt-3">
                                <input type="checkbox" name="Part_time" className="mr-2 w-5 h-5" />Part_time</label>
                        </div>
                    </div>
                </div>
                <div className="w-full lg:w-3/4 p-4">
                    <div className="flex flex-col md:flex-row justify-between items-center mb-4">
                        <h2 className="text-xs sm:text-lg lg:text-3xl font-bold mb-2 md:mb-0">Showing: 0 filtered jobs</h2>
                        <label className="text-xs sm:text-[16px]">Sort by :<select className="p-2 rounded-md">
                            <option>Past 24 hours</option><option>Past 1 week</option><option>Past 1 month</option></select>
                        </label>
                    </div>
                    <div data-aos="zoom-in" className="space-y-4 aos-init aos-animate"></div>
                </div>
            </div>
