                    ...
                    <div className="mx-auto p-20">
                        <div className="flex flex-col items-center md:items-start">
                            <div className="w-full text-center md:text-left">
                                <h1 className="text-2xl sm:text-5xl font-bold text-[#0082da] font-font-sans mt-2">
                                    Services
                                </h1>
                                <h2 className="mt-10 text-3xl sm:text-6xl font-bold text-[#000] font-font-sans">
                                    Range of <span className="text-[#0082da]">Health Care</span> Services
                                </h2>
                                <p className="mt-8 text-lg sm:text-xl md:text-3xl font-semibold text-[#323b4b] leading-7 sm:leading-[42px] md:leading-[56px]">
                                ...
                                <button className="border-4 border-[#0082da] rounded font-bold mt-8 py-3 px-6 sm:py-4 sm:px-8 text-lg sm:text-3xl text-[#0082da]">
                                    View all Vacancies
                                </button>
                            </div>
                        </div>
