                        ...
                        <div className="w-1/2 p-4 shadow-md rounded">
                                ...
                                <h2 className="mt-5 text-3xl font-bold text-[#000] font-font-sans ml-12"><span className="text-[#0082da] mr-3">Welcome,</span>Sign up to RHC 360 Solutions</h2>
                                    <form className="bg-white rounded-lg p-12">
                                        ...
                                        <div className="py-4">
                                            <input type="checkbox" className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2 mr-5" /> 
                                            <span className="text-2xl text-[#000]">Save Password</span>
                                           <a href=""> <span className="ml-auto text-2xl text-[#000]">Forget Password?</span></a>
                                        </div>
                                        <div class="mb-4">
                                            ...
                                            <h2 className="mt-5 text-2xl text-[#000] font-font-sans mt-5 ">Already have an account?<span className="text-[#0082da] ml-3 ">Sign up</span></h2>
                                        </div>
                                    </form>
                                </div>
                            </div>
